...
public class Bishop extends Piece{
    ...
    public Bishop(final Alliance pieceAlliance, final int piecePossition, final boolean isFirstMove) {
        super(PieceType.BISHOP, piecePossition, pieceAlliance, isFirstMove);
    }
